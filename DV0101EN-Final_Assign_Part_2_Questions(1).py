...
@app.callback(
    ...
    Input(component_id='selected_statistics',component_property='options'))

def update_input_container(component_id,component_property):
...
@app.callback(
    ...
    [Input(component_id='select_year', component_property='value'), Input(component_id='selected_statistics', component_property='options')])


def update_output_container(component_id, component_property):
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(yearly_rec,x='Vehicle_Type',y='average_sales'))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_rec= recession_data.groupby('unemployment_rate')
        R_chart4 = dcc.Graph(
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, 
                x='Year',
                y='Automobile_Sales',
                title="Average Automobile Sales over the Whole Period"))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(
                    ...
                    x='Month',
                    y='Automobile_Sales',
                    title='Total Monthly Auto Sales over the Year {}'.format(select_year)))
